				...
				<div class="span10 tileContent">
						...
						if($params->image!='') {
							...
							<div class="tileImage">									
								<a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($item->id));?>">
									<img class="tileImage" src="<?php echo htmlspecialchars($params->image); ?>" alt="<?php echo JText::_('TPL_PIP_IMAGEM_DECORATIVA'); ?>" height="225" width="300" />	
								</a>						
							</div>
							<?php
						}
					...
					<div class="keywords">
						<?php if (!empty($item->metakey)) { ?>
							 <p><?php echo JText::_('TPL_PIP_TAGS'); ?>: <?php TemplateContentCategoriesHelper::displayMetakeyLinks($item->metakey); ?></p>
						<?php } ?>
						<?php
						$parent = $item->get('_parent');
						if(is_object($parent)){ ?>
							<p><?php echo JText::_('TPL_PIP_REGISTRADO_EM'); ?>: <a href="<?php echo JRoute::_(ContentHelperRoute::getCategoryRoute($parent->id)); ?>">
