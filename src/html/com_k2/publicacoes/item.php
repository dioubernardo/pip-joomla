...
<div id="k2Container" class="itemView<?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="content-header-options-1 row-fluid">
		<div class="documentByLine span7">
			...
			<?php echo JText::_('TPL_PIP_PUBLICADO_EM'); ?> <?php echo JHTML::_('date', $this->item->created , JText::_('DATE_FORMAT_LC2')); ?>
			</span>
			...
			<?php endif; ?>
			<span>
			<a title="<?php echo JText::_('TPL_PIP_VOLTAR_PAGINA'); ?>" href="javascript:history.back()"><?php echo JText::_('TPL_PIP_VOLTAR_PAGINA'); ?></a>
			</span>
		</div>
